...
{
  //segment A
  const Gpio::Port segAport = Gpio::Port::F;
  const uint8_t segApin = 0;
  //segment B
  const Gpio::Port segBport = Gpio::Port::A;
  const uint8_t segBpin = 7;
  //segment C
